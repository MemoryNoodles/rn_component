...
// local puzzle
const defaultPuzzle = {
  puzzle: require('./imgs/puzzle.jpg'),
  puzzlePiece: require('./imgs/puzzlePiece.png'),
  pieceOffsetX: 79,
...
const generateSlidingStyles = (
  ...
  icon: <Ionicons name={iconName} size={36} color={iconColor} />,
  buttonColor,
  borderColor,
  indicatorColor
})
...
const slidingStyles = {
  READY: generateSlidingStyles('ios-arrow-round-forward', '#5C6167', 'white', '#e4e7eb', '#e4e7eb'),
  MOVING: generateSlidingStyles('ios-arrow-round-forward', undefined, '#1991fa', undefined, '#d1e9fe'),
  VERIFY_PASS: generateSlidingStyles('ios-checkmark', undefined, '#52ccba', undefined, '#d2f4ef'),
  VERIFY_FAIL: generateSlidingStyles('ios-close', undefined, '#f57a7a', undefined, '#fce1e1')
}

export default class SlideVerify extends Component {
  static propTypes = {
